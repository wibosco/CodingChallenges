...
class QuickSortTests: XCTestCase {
    ...
    func test_quickSortPartialA() {
        ...
        let sortedArray = QuickSort.sortIntoGroups([4, 5, 3, 7, 2], indexOfPivot: 0)
    ...
    func test_quickSortFullA() {
        ...
        let sortedArray = QuickSort.sort([5, 8, 1, 3, 7, 9, 2])
    ...
    func test_quickSortFullB() {
        ...
        let sortedArray = QuickSort.sort([5, 8, 1, 3, 7, 9, 2, 12, 14, 15, 16, 22, 23, 25, 4, 10, 6])
    ...
    func test_quickSortFullC() {
        ...
        let sortedArray = QuickSort.sort([5, 8, 1, 3, 7, 5, 9, 2, 9])
    ...
    func test_quickSortFullAltA() {
        ...
        let sortedArray = QuickSort.sortAlt([5, 8, 1, 3, 7, 9, 2])
    ...
    func test_quickSortFullAltB() {
        ...
        let sortedArray = QuickSort.sortAlt([5, 8, 1, 3, 7, 9, 2, 12, 14, 15, 16, 22, 23, 25, 4, 10, 6])
    ...
    func test_quickSortFullAltC() {
        ...
        let sortedArray = QuickSort.sortAlt([5, 8, 1, 3, 7, 5, 9, 2, 4, 3])
    ...
    func test_quickSortFullInPlaceA() {
        ...
        QuickSort.sortInPlace(&array, leftIndex: 0, rightIndex: (array.count - 1))
