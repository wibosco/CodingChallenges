...
class TimeInWordsTests: XCTestCase {
    ...
    func test_timeInWordsA() {
        ...
        let timeInWords = TimeInWords.timeInWords(5, minute: 15)
    ...
    func test_timeInWordsB() {
        ...
        let timeInWords = TimeInWords.timeInWords(5, minute: 0)
    ...
    func test_timeInWordsC() {
        ...
        let timeInWords = TimeInWords.timeInWords(5, minute: 01)
    ...
    func test_timeInWordsD() {
        ...
        let timeInWords = TimeInWords.timeInWords(5, minute: 10)
    ...
    func test_timeInWordsE() {
        ...
        let timeInWords = TimeInWords.timeInWords(5, minute: 30)
    ...
    func test_timeInWordsF() {
        ...
        let timeInWords = TimeInWords.timeInWords(5, minute: 40)
    ...
    func test_timeInWordsG() {
        ...
        let timeInWords = TimeInWords.timeInWords(5, minute: 45)
    ...
    func test_timeInWordsH() {
        ...
        let timeInWords = TimeInWords.timeInWords(5, minute: 59)
    ...
    func test_timeInWordsI() {
        ...
        let timeInWords = TimeInWords.timeInWords(12, minute: 47)
    ...
    func test_timeInWordsJ() {
        ...
        let timeInWords = TimeInWords.timeInWords(7, minute: 29)
