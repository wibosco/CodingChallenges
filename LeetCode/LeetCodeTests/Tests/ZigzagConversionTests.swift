...
final class ZigzagConversionTests: XCTestCase {
    ...
    func test_A() {
        ...
        let conversion = ZigzagConversion.convert(s, numRows)
    ...
    func test_F() {
        ...
        XCTAssertEqual(conversion, "")
    }
}
