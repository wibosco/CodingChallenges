...
class SortTheMatrixDiagonallyTests: XCTestCase {
    ...
    func test_A() {
        ...
        let sortedMat = SortTheMatrixDiagonally.diagonalSort(mat)
        
        XCTAssertEqual(sortedMat, [[1, 1, 1, 1], [1, 2, 2, 2], [1, 2, 3, 3]])
    }
    ...
    func test_B() {
        ...
        XCTAssertEqual(sortedMat, [[5, 17, 4, 1, 52, 7], [11, 11, 25, 45, 8, 69], [14, 23, 25, 44, 58, 15], [22, 27, 31, 36, 50, 66] ,[84, 28, 75, 33, 55, 68]])
    }
}
