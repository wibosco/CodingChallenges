...
class WallsAndGatesTests: XCTestCase {
    ...
    func test_F() {
        var rooms = [[2147483647], [0], [2147483647], [0], [2147483647], [-1], [2147483647], [0], [0], [2147483647], [2147483647], [0], [2147483647]]
        
        WallsAndGates.wallsAndGates(&rooms)
        
        XCTAssertEqual(rooms, [[1], [0], [1], [0], [1], [-1], [1], [0], [0], [1], [1], [0], [1]])
    }
}
